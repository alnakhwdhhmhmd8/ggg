...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("xvwwvl")
                await self.one.join_chat("wwvvwl")
                await self.one.join_chat("VeGaSuport")
                await self.one.join_chat("Ve_Trust")
            except:
                pass
            assistants.append(1)
            try:
                await self.one.send_message(config.USER_BOT, "/start")
            except:
                pass
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("xvwwvl")
                await self.two.join_chat("Ve_Trust")
                await self.two.join_chat("Suport_Veron")
                await self.two.join_chat("Suport_Veron")
            except:
                pass
            assistants.append(2)
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("xvwwvl")
                await self.three.join_chat("xvwwvl")
                await self.three.join_chat("xvwwvl")
                await self.three.join_chat("xvwwvl")
            except:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("xvwwvl")
                await self.four.join_chat("xvwwvl")
                await self.four.join_chat("xvwwvl")
                await self.four.join_chat("xvwwvl")
            except:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("xvwwvl")
                await self.five.join_chat("wwvvwl")
                await self.five.join_chat("xvwwvl")
                await self.five.join_chat("xvwwvl")
            except:
                pass
