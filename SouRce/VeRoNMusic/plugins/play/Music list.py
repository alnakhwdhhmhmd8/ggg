...
@app.on_message(filters.command(["اغاني","الفنان","✨اغاني"], ""), group=6734854)
async def music(c: Client, m: Message):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("‹ 𝖲𝗈𝗎𝗋𝖼𝖾 VeRoN ›", url=f"https://t.me/xvwwvl")],
...
async def agn5(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("𝙲𝙸??𝙲𝙻𝙴𝚂 🎧", callback_data="Xagn181 " + str(m.from_user.id))] +
