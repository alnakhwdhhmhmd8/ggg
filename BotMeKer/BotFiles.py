...
CHANNEL = "xvwwvl"  # قناة السورس الإجبارية
DEVELOPERS = ["wwvvwl","wwvvwl"]  # قائمة المطورين
...
async def check_subscription(client, message):
    if not SERVICE_ACTIVE and message.from_user.username not in SUDOERS:
        return await message.reply_video(
            video="https://files.catbox.moe/r40wgp.mp4",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("◜ꪔY ժᥱ᥎◞", url="https://t.me/wwvvwl")]
                ]
            )
        )
...
async def show_source(client: Client, message):
    keyboard = InlineKeyboardMarkup([
        [
            InlineKeyboardButton("𝑮𝒓𝒐𝒖𝒑 𝑺𝒖𝒑𝒑𝒐𝒓𝒕", url="https://t.me/xvwwvl"),
            InlineKeyboardButton("𝑪𝒉𝒂𝒏𝒂𝒍 𝑺𝒐𝒖𝒓𝒄𝒆", url="https://t.me/xvwwvl"),
        ],
        [
            InlineKeyboardButton("◜ꪔY ժᥱ᥎◞", url="https://t.me/wwvvwl")
        ]
